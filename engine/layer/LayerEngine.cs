...
{
    /// <summary>
    /// 图层引擎 — Layer 业务逻辑的唯一来源。
    /// </summary>
    public class LayerEngine
    {
        // ===== 查询 =====

        public List<CategoryInfo> GetCategories(StandardConfig config)
        {
        ...
        public List<LayerConfig> GetLayersByCategory(StandardConfig config, string category)
        {
        ...
        public bool SwitchToLayer(ObjectId layerId)
        {
        ...
        public ObjectId CreateLayerFromConfig(LayerConfig cfg)
        {
            Document doc = Application.DocumentManager.MdiActiveDocument;
            Database db = doc.Database;
